...
Route::group(['middleware' => 'auth'], function () {
	...
	//Rotas transferidas para controllers
	// Route::get('user-management', function () { return view('pages.users.user-management');	})->name('user-management');
	// Route::get('user-profile', function () { return view('pages.users.user-profile');	})->name('user-profile');
});